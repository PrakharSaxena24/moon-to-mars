...
function boot(HIKONE) {
  ...
  var COPY = {
    en: {
      ...
      arrivalSpeech: 'Hikone, Lake Biwa. I’ll drive my G-Class. We leave at 06:20. Bring the tanago and suppon home alive, in separate aquariums—never as food. Prakhar, Nishinaga: prepare everything.',
      ...
      driveSpeech: 'The G-Class is loaded exactly as planned. I’ll drive.', driveObjective: 'Yokkaichi → Lake Biwa, Hikone',
    ...
    ja: {
      ...
      loop: ['計画', '実行', '観察', '修正'],
      arrivalSpeech: '彦根の琵琶湖へ行こう。私のゲレンデで、運転は私。06:20出発だ。タナゴとスッポンは生きたまま別々の水槽へ迎える。食用ではない。プラカール、西永、二人で全部準備して。',
      ...
      driveSpeech: 'ゲレンデの積み込みは計画どおりだ。運転は私に任せて。', driveObjective: '四日市 → 彦根・琵琶湖',
