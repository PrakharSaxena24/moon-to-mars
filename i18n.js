...
(function (global) {
  ...
  var STR = {
    en: {
      ...
      hintReadyDay: function (d) { return '✅ No modeled gaps in ' + d + ' — run the rehearsal to test it.'; },
      ...
      vg3: 'The place they stall is the place to fix the plan. Score measures soundness; efficiency measures waiting and rework.',
    ...
    ja: {
      ...
      hintReadyDay: function (d) { return '✅ ' + d + ' にモデル上のギャップなし——リハーサルで検証しましょう。'; },
      ...
      vg1: '全員に役割がある。',
      vg2: 'だが、情報には時刻がある。',
      vg3: '止まった場所こそ、計画を直す場所。Scoreは健全性、Efficiencyは待ち時間と手戻りを測ります。',
      vgPrompt: 'カードを渡す',
      vgSkip: 'スキップ',
      vgReplay: 'もう一度見る ▶',
